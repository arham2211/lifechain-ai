...
type FormStep = "basic" | "symptoms" | "prescriptions";
...
export const DoctorCreateVisit: React.FC = () => {
  ...
  const handleAddSymptom = () => {
    setSymptoms([
      ...symptoms,
      { symptom_name: "", severity: 1, duration_days: 0, notes: "" },
    ]);
  };
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p
                    className={`text-xs mt-2 font-medium ${isActive ? "text-slate-900" : "text-slate-500"
                      }`}
                  >
                    {step.label}
                  </p>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="pt-4">
                <button
                  ...
                  className={`w-full bg-slate-900 text-white py-3.5 rounded-xl font-semibold hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-lg shadow-slate-900/10 ${isLoading ? "opacity-70" : ""
                    }`}
                >
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`flex-1 bg-slate-900 text-white py-3 rounded-xl font-semibold hover:bg-slate-800 transition-colors shadow-lg shadow-slate-900/10 ${isLoading ? "opacity-70" : ""
                    }`}
                >
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const newPrescriptions = [...prescriptions];
                        newPrescriptions[index].duration_days =
                          parseInt(e.target.value) || 0;
                        setPrescriptions(newPrescriptions);
                      }}
                      className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`flex-1 bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-3 rounded-xl font-semibold hover:shadow-lg hover:shadow-emerald-500/20 transition-all shadow-md ${isLoading ? "opacity-70" : ""
                    }`}
                >
